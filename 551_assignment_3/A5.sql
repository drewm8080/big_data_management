SELECT e.first_name, e.last_name, t.title FROM employees e INNER JOIN titles t on t.emp_no=e.emp_no WHERE t.title LIKE "%engineer%" AND t.from_date = "2000-3-23";
